...
switch( $Bbc->mod['task'] )
{
	...
	case 'product': // menu untuk pengaturan product yang dijual
	case 'product_list': // menampilkan daftar product
		include 'product_list.php';
		break;
	case 'product_add': // menu untuk menambah product
	case 'product_list_edit':
		include 'product_edit.php';
		break;
	case 'product_cat': // untuk mengatur semua category product
		include 'product_cat.php';
		break;
	case 'product_bundle': // untuk menampilkan semua product bundling yang akan dijual
		include 'product_bundle.php';
		break;
	case 'product_bundle_add': // untuk menambahk product bundling
	case 'product_bundle_edit':
		include 'product_bundle_edit.php';
		break;
	case 'product_bundlecat': // untuk megatur semua category dari product bundling
		include 'product_bundlecat.php';
		break;
	...
	case 'serial_activate': // daftar serial yg BELUM diaktifkan, nanti di bawah ada tombol untuk Activate All
		...
		break;
	case 'serial_activate_download':
		include 'serial_activate_download.php';
		break;
	...
	case 'config_marketplan': // ringkasan marketplan yang telah dibuat oleh admin
		...
		break;
	case 'config_unilevel': // konfigurasi unilevel yang telah dibuat oleh admin
		# $config = config('plan_a');
		# include 'config_unilevel.php';
		break;

...
$form = _lib('pea',  'bin_product_cat');
$form->initEdit(!empty($category_id) ? 'WHERE id='.$category_id : '');
$form->edit->setLanguage('cat_id');
...
$form->edit->input->title->setTitle('Title / Nama Kategori');
...
$form->edit->input->icon->setFolder($Bbc->mod['dir'].'cat/');
...
$form->edit->addExtrafield('par_id', $category_id);

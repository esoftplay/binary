      ...
      <form action="" method="post" enctype="multipart/form-data" role="form" class="formIsRequire">
        <div class="panel-body">
          ...
          <div class="form-group">
            ...
            <div class="checkbox">
              <label>
                <input type="checkbox" name="serial_card" value="1" />
                Serial dan PIN untuk member dalam bentuk kartu ID yang tercetak ( Serial dan PIN bisa didownload sebelum diaktifkan )
              </label>
            </div>
            <div class="checkbox">
              <label>
                <input type="checkbox" name="serial_check" value="1" />
                Pastikan hanya serial yang sudah di beli oleh member saja yang bisa diaktifasi ( digunakan untuk registrasi )
              </label>
            </div>

		...
		foreach ($r_data as $key => $value) 
		{
			...
			<div class="col-md-4 statMenu">
				<div class="text-center py-3 testiHead <?php echo $r_class[$key]; ?>">
					<img src="templates/beauty_purple/html/img/index/icon_statistik1.png" class="mr-2" style="max-width: 15%;">
								...
								<div class="item carousel-item<?php echo $active ?>">
									...
									foreach ($value1 as $key2 => $value2)
									{
										...
										<div class="row mb-3 d-flex-c">
											<div class="col-5">
												<img src="<?php echo _URL?>templates/beauty_purple/html/img/index/icon_statistik2.png" class="img-fluid" style="width: 80%">
											</div>

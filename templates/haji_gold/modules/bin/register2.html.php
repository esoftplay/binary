...
<div class="row">
	<div class="col-md-12">
		<h4 class="text-center" style="color: #bc8716; font-weight: bold;"><?php echo @$output['user_data']['username']; ?></h4>
	</div>
</div>
<div class="row">
	<div class="col-md-12 text-center">
		<a href=""><button class="w3-btn w3-ripple" style="margin-top: 25px; background-color: #bc8716; color:white;"><?php echo lang('Daftar Lagi') ?></button></a>
	</div>          
</div>
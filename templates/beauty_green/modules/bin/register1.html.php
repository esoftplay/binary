...
<div class="row d-flex-c">
	<div class="col-md-10">
		<br>
		<p style="color: green; font-weight: bold; text-align: left;"><?php echo lang('Data Jaringan'); ?></p>
		<br>
		<hr>
	</div>
</div>
...
<div class="row d-flex-c">
	<div class="col-md-10">
		<br>
		<p style="color: green; font-weight: bold; text-align: left;"><?php echo lang('Data Kartu'); ?></p>
		<br>
		<hr>
	</div>
</div>
...
<div class="row d-flex-c">
	<div class="col-md-10">
		<br>
		<p style="color: green; font-weight: bold; text-align: left;"><?php echo lang('Data Pribadi'); ?></p>
		<br>
		<hr>
	</div>
</div>
...
<div class="row">
	<div class="col-md-12 text-center">
		<a href="<?php echo site_url('bin/register') ?>?bin_register_step_back=0" class="w3-btn w3-ripple" style="margin-top: 25px; background-color: white; color: green; font-weight: bold; border: 1px solid green;"><?php echo lang('Kembali'); ?></a>
		<button type="submit" name="add_submit_add" value="Register" class="w3-btn w3-ripple" style="margin-top: 25px; background-color: green; color: white; font-weight: bold;border: 1px solid green;" disabled="disabled"><?php echo lang('Aktifkan Akun'); ?></button>
	</div>          
</div>

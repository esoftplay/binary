			...
			foreach((array)$arr as $k => $data)
			{
				...
				<div class="item carousel-item<?php echo $active?>">
					<div class="about-index">
						<img class="about-index_bg" src="<?php echo content_src($data['image']); ?>">
						<div class="container">
							<div class="row">
								<div class="col-md-12">
									<?php
							...
							<div class="row" style="margin: 0;">
								<div class="col-md-12 no-both about-p">
									<div class="col-md-4 no-both">
									...
									<div class="col-md-8">
										<p><?php echo $data['content'];?>
											...
											if (!empty($config['read_more']))
											{
												?>
												<br>
												<a href="<?php echo $link; ?>" class="text_green"><?php echo lang('see more'); ?>

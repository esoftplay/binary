...
<div class="row regText2">
	<div class="col-md-8 col-md-offset-2">
		<p><?php echo lang('Silahkan isi form yang ada dengan benar, Pastikan identitas yang diisikan sudah sesuai untuk keanggotaan anda'); ?></p>
	</div>
</div>
<div>
...
<div class="row">
	<div class="col-md-10 col-md-offset-1 subTitleReg">
		<br>
		<p><?php echo lang('Data Jaringan'); ?><hr></p>
	</div>
</div>
...
<div class="row">
	<div class="col-md-10 col-md-offset-1 subTitleReg">
		<br>
		<p><?php echo lang('Data Kartu'); ?><hr></p>
	</div>
</div>
<div class="row d-flex">
...
<div class="row">
	<div class="col-md-10 col-md-offset-1 subTitleReg">
		<br>
		<p><?php echo lang('Data Pribadi'); ?><hr></p>
	</div>
</div>
...
<div class="row">
	<div class="col-md-12 text-center">
		<a href="<?php echo site_url('bin/register') ?>?bin_register_step_back=0" class="w3-btn w3-ripple"><?php echo lang('Kembali'); ?></a>
		<button type="submit" name="add_submit_add" value="Register" class="w3-btn w3-ripple" disabled="disabled"><?php echo lang('Aktifkan Akun'); ?></button>
	</div>          
</div>

...
<div class="row">
	<div class="col-md-12 text-center">
		<button type="submit" name="bin_register_step" value="1" class="w3-btn w3-ripple" style="margin-top: 25px; background-color: #774500; color: white; font-weight: bold;" disabled="disabled"><?php echo lang('Selanjutnya'); ?></button>
	</div>          
</div>

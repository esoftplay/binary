...
<div class="row regText">
	<div class="col-md-8 col-md-offset-2">
		<p><?php echo lang('Silahkan lakukan pendaftaran, Pastikan ID Sponsor, ID Upline, dan posisi node yang anda masukkan benar, karena tidak bisa melakukan perubahan lagi jika anda sudah mengetahui sponsor dan upline anda, silahkan isi form di bawah ini'); ?></p>
	</div>
</div>
...
<div class="row">
	<div class="col-md-12 text-center nxtButton">
		<button type="submit" name="bin_register_step" value="1" class="w3-btn w3-ripple" disabled="disabled"><?php echo lang('Selanjutnya'); ?></button>
	</div>          
</div>
